...
class StickerPackInfoViewController: UITableViewController {
    ...
    Bu sticker paketini WhatsApp'a ekledikten sonra, bu sticker'ları WhatsApp üzerinden herkese \
    gönderebilirsin. Paketi silmek için WhatsApp'taki "Sticker'larım" panelini kullan.
    """
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row <= 2 {
            ...
            case 0:
                ...
                secondaryCell.secondaryText = "Simge"
            case 1:
                secondaryCell.primaryText = stickerPack.publisher
                secondaryCell.secondaryText = "Yayıncı"
            case 2:
                secondaryCell.primaryText = stickerPack.formattedSize
                secondaryCell.secondaryText = "Boyut"
            default:
                break
            }
        } else {
            ...
            case index(ofWebsite: .licenseAgreement):
                linkCell.linkTitle = "Lisans Sözleşmesi"
