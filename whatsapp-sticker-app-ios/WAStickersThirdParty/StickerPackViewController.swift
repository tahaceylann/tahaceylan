...
class StickerPackViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        addButton.setTitle("WhatsApp'a Ekle", for: .normal)
        ...
        tapGuideLabel.text = "Kopyalamak veya paylaşmak için bir sticker'a dokun"
    ...
    func showActionSheet(withSticker sticker: Sticker, overCell cell: UICollectionViewCell) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Panoya Kopyala", style: .default, handler: { _ in
            sticker.copyToPasteboardAsImage()
        }))
        actionSheet.addAction(UIAlertAction(title: "Şununla Paylaş", style: .default, handler: { _ in
    ...
    @objc func addButtonPressed(button: AquaButton) {
        let loadingAlert: UIAlertController = UIAlertController(title: "WhatsApp'a gönderiliyor", message: "\n\n", preferredStyle: .alert)
